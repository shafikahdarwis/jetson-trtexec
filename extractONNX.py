...
line_of_prototxt = find_line_of_interest(args["file"], 'Model:', 0)
...
list_of_prototxt = list_of_interest(line_of_prototxt, 34)
...
print("Model: %s" % os.path.basename(usedPrototxt))
...
with open(dirPath, mode='w') as extract_file:
	...
	extract_writer.writerow(["Model", usedPrototxt])
